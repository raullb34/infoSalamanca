...
docker rm -f infosalamanca-nginx infosalamanca-frontend infosalamanca-backend infosalamanca-mongodb infosalamanca-langflow 2>/dev/null || true

# Limpiar volúmenes no utilizados (solo Redis)
log "🗑️  Limpiando volúmenes de Redis..."
